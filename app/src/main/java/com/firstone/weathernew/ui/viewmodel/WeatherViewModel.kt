package com.firstone.weathernew.ui.viewmodel
...
import com.firstone.weathernew.util.*
...
class WeatherViewModel(private val repository: WeatherRepository) :
    ...
    private lateinit var weatherResponse: WeatherDataResponseNew
        ...
        viewModelScope.launch(Dispatchers.IO) {
            try {
                ...
                withContext(Dispatchers.Main) {
                    ...
                    weatherDetail.icon = null
                    weatherDetail.cityName = weatherResponse.city
                    weatherDetail.countryName = weatherResponse.country
                    weatherDetail.temp = weatherResponse.temperature
    ...
    private suspend fun addWeatherDetailIntoDb(weatherResponse: WeatherDataResponseNew) {
        val weatherDetail = WeatherDetail()
        //weatherDetail.id = weatherResponse.id
        weatherDetail.icon = null
        weatherDetail.cityName = weatherResponse.city
